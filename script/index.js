...
var ahtml= `<div class="alert alert-`+((a.serverURL != openedServer[2]) ? ((a.serverOnline) ?`primary`:`danger`):`success`)+`" style="margin-bottom: 1px; "><strong>
...
var fetchServer = async function(surl){
	...
	return jsonResolved
		...
		return {online:0,version:"Not Online"}
	}
